...
$.garm.config={classFormBusy:"busy",classFieldError:"error",classFieldLoading:"loading",classLabelError:"",attr:"data-garm",attrIgnore:"data-garm-ignore",onlyValidate:!1,beforeSubmit:function(){},onSubmit:function(a){},onSuccess:function(a){},onFail:function(a){}};
$.garm.validate=function(a,b,c){a.beforeSubmit();if(c.hasClass(a.classFormBusy))return $.garm.info("VALIDATION ALREADY BUSY"),!1;$.garm.info("VALIDATION STARTED");var d=c.find("["+a.attr+"]").not("["+a.attr+'=""]'),h=c.find("label"),l=0,p=[];d.removeClass(a.classFieldError);h.removeClass(a.classLabelError);c.addClass(a.classFormBusy);d.each(function(){var d=$(this),h=d.val(),g=d.attr("name"),q=d.attr(a.attr).split(" "),r;for(r in q){var e=q[r],t=[];-1!==e.indexOf("[")&&(t=e.substring(e.indexOf("[")+
1,e.length-1).split(","),e=e.substring(0,e.indexOf("[")));var m=d.is("["+a.attrIgnore+'~="'+e+'"]')||d.is("["+a.attrIgnore+'="all"]'),n=d.parents("["+a.attrIgnore+"]");n.length&&(m=n.is("["+a.attrIgnore+'~="'+e+'"]')||n.is("["+a.attrIgnore+'="all"]'));m&&$.garm.info("validation ignored (field: "+g+", validator: "+e+")");if(e in b&&!d.hasClass(a.classFieldError)&&!m){var f=b[e];p.push(function(){var b=$.Deferred();if("function"==typeof f){var k=f(t,h,d,c,b);"undefined"==typeof k||"undefined"==typeof k.promise?
