...
if(c.hasClass(a.classFormBusy))return d.garm.info("VALIDATION ALREADY BUSY"),!1;d.garm.info("VALIDATION STARTED");var f=c.find("["+a.attr+"]").not("["+a.attr+'=""]'),h=c.find("label"),n=0,m={},r=[];f.removeClass(a.classFieldError);h.removeClass(a.classLabelError);c.addClass(a.classFormBusy);f.each(function(){var e=d(this),f=e.val(),k=e.attr("name"),h=e.attr(a.attr).split(" "),t;for(t in h){var g=h[t],u=[];-1!==g.indexOf("[")&&(u=g.substring(g.indexOf("[")+1,g.length-1).split(","),g=g.substring(0,
g.indexOf("[")));var p=e.is("["+a.attrIgnore+'~="'+g+'"]')||e.is("["+a.attrIgnore+'="all"]'),q=e.parents("["+a.attrIgnore+"]");q.length&&(p=q.is("["+a.attrIgnore+'~="'+g+'"]')||q.is("["+a.attrIgnore+'="all"]'));p&&d.garm.info("validation ignored (field: "+k+", validator: "+g+")");if(g in b&&!e.hasClass(a.classFieldError)&&!p){var l=b[g];r.push(function(){var b=d.Deferred();if("function"==typeof l){var h=l(u,f,e,c,b);"undefined"==typeof h||"undefined"==typeof h.promise?b.resolve(1==h):(b=h,e.addClass(a.classFieldLoading))}else"string"==
typeof l&&0===l.indexOf("http")?(e.addClass(a.classFieldLoading),d.get(l,{value:f}).always(function(a){b.resolve(1==d.trim(a))})):l instanceof RegExp&&b.resolve(l.test(f));b.always(function(b){e.removeClass(a.classFieldLoading);0==b&&(n++,"undefined"!=typeof k&&("undefined"==typeof m[k]&&(m[k]=[]),m[k].push(g)),e.addClass(a.classFieldError),c.find('label[for="'+e.attr("id")+'"]').addClass(a.classLabelError),d.garm.debugMode&&("undefined"==typeof k&&(k=e[0].tagName.toLowerCase(),k+=e.is("[id]")?"#"+
